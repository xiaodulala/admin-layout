...
//go:generate codegen --type=int --docs --output ../../../docs/guide/zh-CN/api/error_code_generated.md
// 通用基本错误
const (
	// ErrSuccess - 200: OK.
...
const (
	...
	// ErrDataPermissionDenied - 403: Data Permission denied.
	ErrDataPermissionDenied
)
